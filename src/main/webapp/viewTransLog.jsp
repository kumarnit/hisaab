...
for(Cookie cookie : cookies){
	if(cookie.getName().equals("user")) {userName = cookie.getValue();
		if(userName.equalsIgnoreCase("admin")){
			...
			out.print("<body><h3 align=\"center\"> Transaction Logs</h3><table id=\"itemExpiryTable\" class=\"display\" cellspacing=\"0\" width=\"75%\"><thead><tr><th>Id</th><th align=\"center\">Contact No</th><th align=\"center\">User Name</th><th align=\"center\">Trans Type</th><th align=\"center\">Created time</th></tr></thead><tbody></tbody></table></body>");
		}
	 }
}
}
	...
	var editor; // use a global for the submit and return data rendering in the examples
		...
		$(document).ready(function(){
			...
			$("#itemExpiryTable").DataTable( {
		        ...
		        "ajax": {
		            url: "rest/v1/viewlogs/get/transactionLog",
		            type: 'GET'
