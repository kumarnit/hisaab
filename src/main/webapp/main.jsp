...
<!-- <form action="TestingSer" method="post">
...
<section id="login">
    <div class="container">
    	<div class="row">
    	    <div class="col-xs-12">
        	    <div class="form-wrap">
                <h1>Log in with Your User Name and Password</h1>
                    <form role="form" id="login-form" autocomplete="off" action="TestingSer" method="post">
